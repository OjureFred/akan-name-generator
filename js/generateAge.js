function getValues() {
  ...
  var dayName = dayOfWeekName(dow);

  function dayOfWeekName(dayOfWeek) {
    return dayOfWeekArr[dow];
  }
  ...
  //display values in web page
  var akanFinalName = document.getElementById("akan-name");
  var akanSecondFinalName = document.getElementById("akan-name2");
  var dayofWeekDisplay = document.getElementById("dayOfWeek");

  akanFinalName.innerHTML = genName;
  akanSecondFinalName.innerHTML = genName;
  dayofWeekDisplay.innerHTML = dayName;
}
